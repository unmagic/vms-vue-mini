...
export function defineComponent(setup: ComponentSetup<{}>, config?: Config): string
...
export function defineComponent<
  ...
  Methods extends WechatMiniprogram.Component.MethodOption,
  Behavior extends WechatMiniprogram.Component.BehaviorOption,
>(options: ComponentOptions<Props, Data, Methods, Behavior>, config?: Config): string
...
export function defineComponent(optionsOrSetup: any, config?: Config): string {
  ...
  const originReady =
    options.lifetimes[ComponentLifecycle.READY] || options[ComponentLifecycle.READY]
  ...
  if (options.methods[PageLifecycle.ON_PAGE_SCROLL] || config.listenPageScroll) {
  ...
  options.pageLifetimes[SpecialLifecycleMap[PageLifecycle.ON_SHOW]] = createSpecialPageLifecycle(
    options,
    PageLifecycle.ON_SHOW,
  )
  options.pageLifetimes[SpecialLifecycleMap[PageLifecycle.ON_HIDE]] = createSpecialPageLifecycle(
    options,
    PageLifecycle.ON_HIDE,
  )
  options.pageLifetimes[SpecialLifecycleMap[PageLifecycle.ON_RESIZE]] = createSpecialPageLifecycle(
    options,
...
function createPageLifecycle(options: Options, lifecycle: PageLifecycle): (...args: any[]) => void {
